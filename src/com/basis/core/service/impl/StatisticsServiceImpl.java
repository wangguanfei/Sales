...
public class StatisticsServiceImpl implements IStatisticsService{
	...
	*/ 
	...
	public Map<String, Object> getYearMap(String nowYear) {
		String sql = "SELECT  s_month statisticMonth, SUM(s_in) income,SUM(s_profit) profit FROM `zsgx_statistics` WHERE s_year='"+nowYear+"' GROUP BY s_month ORDER BY s_month";
		List<StatisticsDto> list = dao.getSession().createSQLQuery(sql).setResultTransformer(Transformers.aliasToBean(StatisticsDto.class)).list();
