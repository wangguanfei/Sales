...
<head>
	...
	<script type="text/javascript">
		function factoryInfo_edit_submit(dialog,frm,_url){
			commonFrmSubmit(
					"#zsgx_factoryInfo_edit_form",
					basePath+"zsgx/factoryInfo!doEdit.action",
					function(json){
						if(json.success){
...
<body>
 	<form id="zsgx_factoryInfo_edit_form" name="zsgx_factoryInfo_edit_form" class="l-form validate" method="post">
