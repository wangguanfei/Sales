...
<head>
	...
	<script type="text/javascript">
		function statistics_edit_submit(dialog,frm,_url){
			commonFrmSubmit(
					"#zsgx_statistics_edit_form",
					basePath+"zsgx/statistics!doEdit.action",
					function(json){
						if(json.success){
		        			home_fresh();
						}else{
...
<body>
 	<form id="zsgx_statistics_edit_form" name="zsgx_statistics_edit_form" class="l-form validate" method="post">
