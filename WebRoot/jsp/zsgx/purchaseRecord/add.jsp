...
<head>
	...
	<script type="text/javascript">
		function purchaseRecord_add_submit(dialog,frm,_url){
			commonFrmSubmit(
					"#zsgx_purchaseRecord_add_form",
...
<body>
 	<form id="zsgx_purchaseRecord_add_form" name="zsgx_purchaseRecord_add_form" class="l-form validate" method="post">
