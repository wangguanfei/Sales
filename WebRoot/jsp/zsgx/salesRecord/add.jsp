...
<head>
	...
	<script type="text/javascript">
		function salesRecord_add_submit(dialog,frm,_url){
			commonFrmSubmit(
					"#zsgx_salesRecord_add_form",
					basePath+"zsgx/salesRecord!doAdd.action",
					function(json){
						if(json.success){
		        			home_fresh();
						}else{
...
<body>
 	<form id="zsgx_salesRecord_add_form" name="zsgx_salesRecord_add_form" class="l-form validate" method="post">
