...
<body>
	 ...
	 <input type="hidden" name="goods.stock" value="${goods.stock}"/>
	    <div class="content">
	    	...
	    	<ul>
	    		<li>
					...
					<!-- <font color="red">商品图片提示</font> -->
				</li>
	    	</ul>
	    	<ul <c:if test="${empty goods.img}">style="display: none;"</c:if> id="view">
	    		<li>
	    		<label><font color="red"></font>预览图片：</label>
	    			<img alt="" src="${basePath}${goods.img}" id="viewImg">
				</li>
	    	</ul>
	    	<ul>
	    		<li>
