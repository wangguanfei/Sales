    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        loadData: function (loadDataParm)
        {
            ...
            if (p.parms)
            {
                ...
                /**wxliu modify 2012/7/26 支持function 返回数组参数 */
                else if(typeof p.parms == "function"){
                	var fun=p.parms;
                	param=param.concat(fun());
...
(function ($)
{
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                g.left = $("> div[position=left]", g.layout).wrap('<div class="l-layout-left" style="left:0px; overflow-y: auto;"></div>').parent();
